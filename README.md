...
│   │   ├── postGenerator.js      # Генерация новых постов
│   │   ├── siteBuilder.js
│   │   └── templateEngine.js
│   ├── bin/              # CLI интерфейс
│   │   └── blog-engine.js
...
1. **Создание нового поста**:
   - Вариант 1: Запустите `npm run new` и введите название статьи в интерактивном режиме
     ```bash
     $ npm run new
...
В движке поддерживаются следующие команды:
