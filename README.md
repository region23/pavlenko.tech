...
3. **Настройка стилей**:
   ...
   - Основные файлы стилей:
     ...
     - `components/variables.css` - CSS переменные (автоматически генерируются из конфигурации)
     - `components/base.css`, `components/typography.css` и др. - Компонентные стили
...
2. **Добавление новых стилей**:
   - Создайте новые CSS файлы в директории `blog/css/` или `blog/css/components/`
   - Импортируйте их в `style.css`
